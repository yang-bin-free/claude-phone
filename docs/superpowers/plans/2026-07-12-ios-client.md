...
- [x] **Step 1: Write host tests for facade lifecycle**
...
- [x] **Step 3: Add gomobile-safe contracts and host fallback**
...
- [x] **Step 4: Add iOS packet bridge lifecycle**
...
- [x] **Step 5: Verify host tests and mobile bind package discovery**
...
- [x] **Step 1: Add a failing validator invocation**
...
- [x] **Step 2: Implement XCFramework build script**
...
- [x] **Step 3: Implement deterministic static validation**
...
- [x] **Step 1: Create configuration with no committed signing identity**
...
- [x] **Step 2: Add app and extension metadata**
...
- [x] **Step 3: Create minimal SwiftUI and tunnel entry points**
...
- [x] **Step 4: Add all targets and source membership to pbxproj**
...
- [x] **Step 1: Write Codable fixture tests**
...
- [x] **Step 2: Implement protocol models**
...
- [x] **Step 3: Implement Keychain and shared configuration**
...
- [x] **Step 4: Implement WebSocket transport and retry**
...
- [x] **Step 5: Run tests when Xcode is available and static checks now**
...
- [x] **Step 1: Write pairing state tests**
...
- [x] **Step 2: Implement NETunnelProviderManager controller**
...
- [x] **Step 3: Implement pairing and settings UI**
...
- [x] **Step 3: Implement SwiftUI views**
...
- [x] **Step 1: Implement permission-testable speech controller**
...
- [x] **Step 2: Implement packet flow adapter**
...
- [x] **Step 3: Implement Extension lifecycle**
...
- [x] **Step 1: Document prerequisites and configuration**
...
- [x] **Step 2: Add release packaging guard**
...
- [x] **Step 3: Run all available verification**
...
- [x] **Step 4: Run credential and signing scans**
...
- Source implementation landed on `master` in `b14df3e` with documentation in `af2d6de`.
- CI run `29166833274` generated `ClaudeCore.xcframework` with the iPhoneOS SDK and compiled the SwiftUI app plus Packet Tunnel Extension for the iOS Simulator without signing.
- The same run passed Android and Go/security jobs.
- Remaining device-stage prerequisites are external: accept the local Xcode license, configure an Apple Developer Team, App Group and Network Extension entitlement, sign on an iOS 18 device, then run the documented tailnet and speech acceptance checklist.
